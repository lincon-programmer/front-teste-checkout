window.onload = function(){
    ...
    if(nao_autorizado == "true"){
        ...
        var cardName = window.localStorage.getItem("cardName", cardName);
        var cardNumber = window.localStorage.getItem("cardNumber", cardNumber);
        var cardValidate = window.localStorage.getItem("cardValidate", cardValidate);
        var cardCvv = window.localStorage.getItem("cardCvv", cardCvv);
        var parcelas = window.localStorage.getItem("parcelas", parcelas);

        document.getElementById("cardName").value = cardName;
        document.getElementById("cardNumber").value = cardNumber;
        document.getElementById("cardValidate").value = cardValidate;
        document.getElementById("cardCvv").value = cardCvv;
        document.getElementById("installment").value = parcelas;
    }
}
